...
package com.example.freeze_tag.object_detection.env;
...
public class ImageUtils {
  ...
  static {
    try {
      ...
      Log.w("IMAGE_UTILS", "Native library not found, native RGB -> YUV conversion may be unavailable.");
    }
  }
  ...
  public static Matrix getTransformationMatrix(
    ...
    if (applyRotation != 0) {
      if (applyRotation % 90 != 0) {
        Log.w("IMAGE_UTILS","Rotation of %d % 90 != 0" + applyRotation);
      }
